                                ...
                                <div class="mainmenu clearfix hidden-sm hidden-xs">
                                    <nav>
                                        <ul>
                                            ...
                                            <li><a href="#">Blog</a>
                                                <ul>
                                                    <li><a href="blog_1.php">Giới thiệu về Áo Polo của PoloBee</a></li>
                                                    <li><a href="blog_2.php">Văn hóa của PoloBee</a></li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="shopping-cart.php"><i class="fa fa-shopping-cart"></i>
                                                ...
                                                <li class="total-amount clearfix">
                                                            ...
                                                            <span class="floatright"><strong><span> VNĐ</span></strong></span>
