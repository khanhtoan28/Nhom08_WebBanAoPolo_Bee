                ...
                <div class="bend niceties preview-2 hm-ver-1">
                    ...
                    <div id="slider-direction-3" class="t-cn slider-direction Builder">
                        <div class="slide-all">
                            ...
                            <!-- layer 2 -->
                            <div class="layer-2">
                                <h2 class="title6">PoloBee Store</h2>
                            </div>
                            <!-- layer 2 -->
                            <div class="layer-2">
                    ...
                    <div id="slider-direction-1" class="t-cn slider-direction Builder">
                        <div class="slide-all slide2">
                            ...
                            <!-- layer 2 -->
                            <div class="layer-2">
                                <h2 class="title6">PoloBee Fashion</h2>
                            </div>
                            <!-- layer 2 -->
                            <div class="layer-2">
                ...
                <div class="section-padding1">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="banner-box banner-box-re">
                                <a href="shop.php?id_category=3">
                                    <img alt="" src="images/banner/i1.jpg">
                                    <div>
                                        <h2>
                                            Polo
                                        </h2>
                                        <p>Duyên dáng sang trọng, chất lượng vượt thời gian - PoloBee Store, nơi phong cách trở thành đẳng cấp.</p>
                                    </div>
                                </a>
                            </div>
                            <div class="banner-box res-btm">
                                <a href="shop.php?id_category=1">
                                    <img alt="" src="images/banner/i2.png">
                                    <div>
                                        <h2>
                                            Polo
                                        </h2>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="banner-container banner-box res-btm">
                                <a href="shop.php?id_category=2">
                                    <img alt="" src="images/banner/i4.jpg">
                                    <div>
                                        <h2>
                                            Polo
                                        </h2>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="banner-box banner-box-re">
                                <a href="shop.php?id_category=2">
                                    <img alt="" src="images/banner/i3.jpg">
                                    <div>
                                        <h2>
                                            Polo
                                        </h2>
                            ...
                            <div class="banner-box">
                                <a href="shop.php?id_category=4">
                                    <img alt="" src="images/banner/i5.jpg">
                                    <div>
                                        <h2>
                                            Polo
                                        </h2>
				...
				<div class="row">
					<div id="blog" class="owl-carousel product-slider owl-theme re-blog">
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                <div class="post-thumb">
                                    <a href="blog.html"><img class="attachment-blog-list wp-post-image" alt="blog-2" src="images/banner/i3.jpg"></a>
                                </div>
                                <div class="visual-inner">
                                    <h2 class="blog-title">
                                        <div class="name">Phụ kiện thời trang - Khám Phá Sự Lịch Lãm Tại PoloBee Store</div>
                                    </h2>
                                    <div class="blog-meta">
                                        <span class="post-category">
                                            in
                                            <a rel="category" href="blog.html">PoloBee Store</a>
                                        </span>
                                    ...
                                    Tại PoloBee Store, chúng tôi tin rằng chi tiết là chìa khóa để tạo nên phong cách độc đáo. 
						...
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                <div class="post-thumb">
                                    <a href="blog.html"><img class="attachment-blog-list wp-post-image" alt="blog-2" src="images/Blog/2.jpg"></a>
                                </div>
                                <div class="visual-inner">
                                    <h2 class="blog-title">
                                        <div class="name">Áo Sơ Mi - Khám Phá Sự Tinh Tế Tại PoloBee Store</div>
                                    </h2>
                                    <div class="blog-meta">
                                        <span class="post-category">
                                            in
                                    ...
                                    <div class="blog-content"> 
                                    PoloBee Store tự hào về bộ sưu tập áo sơ mi nam phong phú từ các thương hiệu hàng đầu thế giới. 
						...
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                <div class="post-thumb">
                                    <a href="blog.html"><img class="attachment-blog-list wp-post-image" alt="blog-2" src="images/banner/vip.webp"></a>
                                </div>
                                <div class="visual-inner">
                                    <h2 class="blog-title">
                                        <div class="name">Polo - Khám Phá Sự Hoàn Hảo Tại PoloBee Store</div>
                                    </h2>
                                    <div class="blog-meta">
                                        <span class="post-category">
                                            in
                                    ...
                                    <div class="blog-content"> 
                                    Tại PoloBee Store, chúng tôi hiểu rằng đôi giày không chỉ là một phần của bộ trang phục mà còn là biểu tượng của phong cách và đẳng cấp. 
						...
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                ...
                                <div class="visual-inner">
                                    <h2 class="blog-title">
                                        <div class="name">Áo Vest - Sự Lịch Lãm Tại PoloBee Store</div>
                                    </h2>
                                    <div class="blog-meta">
                                        <span class="post-category">
                                            in
...
#banner1 {
    ...
    background-image :url("images/banner/i2.png");
