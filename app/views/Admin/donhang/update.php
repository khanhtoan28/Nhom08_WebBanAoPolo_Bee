...
<form action="AdminController.php?act=updatedh" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="tonghoadon" name="iddh" class="form-control" value="">
              </div>
              <div class="form-group">
                <label for="tonghoadon">ID Khách hàng</label>
                <input type="text" id="tonghoadon" name="id_kh" class="form-control" value="">
              </div>
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" id="tonghoadon" name="tongdonhang" class="form-control" vvalue="">
              </div>
              <div class="form-group">
